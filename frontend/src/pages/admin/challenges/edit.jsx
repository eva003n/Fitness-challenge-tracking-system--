...
import { getChallengeData, updateChallenge } from "../../../services";
import { useParams } from "react-router-dom";
import { useAuth } from "../../../context/authProvider";
import { toast } from "react-toastify";
import { Loader } from "lucide-react";
import {getDateByYear, getDateByMonth} from "../../../services/formatDate"
    ...
    return <Container>
        ...
        />
         {/* <form
          ...
          className="mx-auto  max-w-[36rem] grid gap-4 rounded-lg bg-gray-100 px-4 py-8 text-violet-700  dark:bg-slate-900"
          disabled={isLoading}
        >
          ...
          <div className=" grid gap-2">
            <div className="flex items-center justify-center bg-gray-800 h-[16rem] p-4">
              {thumbnail || data.image.imageUrl ? (
                <div className="relative  w-1/2 rounded-sm  flex items-center ">
                  <X
